...
Usage: EFAddedProfiles.py -i INPUT_DIR -o OUTPUT_DIR --filepattern=<filepattern> [--frequency=<frequency>] [--number_of_testf=<number_of_testf>] [--nbin=<nbin>] [--df=<float>] [--signal_strength=<signal_strength>]
...
def main():
    ...
    output = data['output_dir'] + 'KM3NeT_chi2_added.hdf5'
