...
def plot_angular_resolution_vs_energy(table, reco_type_id, reco_stage_id, reco_name, energy_range, n_bins, run_type, plt_scale, file_name):
    ...
    output_plotname = "TestPlotAngularRes" + reco_name + "_" + run_type + "_" + plt_scale + "_" + file_name + ".png"
    ...
    output_histname = "HistogramSeparations_" + reco_name + "_" + run_type + "_" + plt_scale + "_" + file_name + ".png"
...
def main():
    ...
    output_file_name = os.path.join(output_dir, f"{common_prefix}")
    ...
    plot_angular_resolution_vs_energy(result_table, reco_type_id, reco_stage_id, reco_type , energy_range, n_bins,run_type,plt_scale,common_prefix)
