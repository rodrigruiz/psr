...
workflow{
    ...
    if (input.filestype == 'data') {
        ...
        Channel
            .fromPath("/home/hpc/capn/capn107h/software/psr/workflows/km3net/data_files_arca_v9.txt")
            .splitText(by: 1)
            .combine(Channel.of('arca'))
            .set { ARCA_Files_Channel }
        ...
        ConvertFilesKM3NeT(ARCA_Files_Channel)
        AddTrackScoreKM3NeT(ConvertFilesKM3NeT.out, input.parampid_folder)
        eventlist_input_data_arca = AddTrackScoreKM3NeT.out
        //eventlist_input_data_arca = ARCA_Files_Channel
    } else if (input.filestype == 'data_arca_conv') {
        Channel
            .fromPath("/home/hpc/capn/capn107h/software/psr/workflows/km3net/data_files_arca_v9_converted_backup.txt")
            .splitText(by: 1)
            .combine(Channel.of('arca'))
            .set { ARCA_Files_Channel }
        ...
        // AddTrackScoreKM3NeT(ConvertFilesKM3NeT.out, input.parampid_folder)
        // eventlist_input_data_arca = AddTrackScoreKM3NeT.out
        eventlist_input_data_arca_conv = ARCA_Files_Channel
    } else if (input.filestype == 'data_orca_conv') {
        Channel
            .fromPath("/home/hpc/capn/capn107h/software/psr/workflows/km3net/data_files_orca_v9_converted.txt")
            .splitText(by: 1)
            .combine(Channel.of('orca'))
            .set { ORCA_Files_Channel }
        ...
        // AddTrackScoreKM3NeT(ConvertFilesKM3NeT.out, input.parampid_folder)
        // eventlist_input_data_arca = AddTrackScoreKM3NeT.out
        eventlist_input_data_orca_conv = ORCA_Files_Channel
    } else {
    ...
    */
    ...
    if (input.filestype == 'mcv') {
        ...
        eventlist_input = eventlist_input_data_arca
    } else if (input.filestype == 'data_arca_conv') {
        eventlist_input = eventlist_input_data_arca_conv
    } else if (input.filestype == 'data_orca_conv') {
        eventlist_input = eventlist_input_data_orca_conv
    }
